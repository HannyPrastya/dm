...
public class BaseApriori<V> extends AbstractApriori<V> {
    ...
    public BaseApriori(List<ItemSet<V>> transactions) {
        super(transactions);
    }
    ...
    public void apriori(Double minSupport) {
        ...
        System.out.println("\tGenerated " + candidatesLevel1.size() + " candidates.");
        System.out.println("\t\t" + candidatesLevel1);

        // prune 1-itemsets
        List<ItemSet<V>> frequentCandidatesLevel = pruneInfrequentCandidates(minSupport, candidatesLevel1);
        System.out.println("\tKept " + frequentCandidatesLevel.size() + " frequent itemsets");
        ...
        for (int i = 2; ; i++) {
            ...
            System.out.println("\tGenerated " + generateCandidateSizeK.size() + " candidates.");
